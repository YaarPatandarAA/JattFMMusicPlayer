 ...
 */
public class fragment_albumsHindi extends Fragment {
    int pageNum = 1;
    ...
    private void getWebsiteInit() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Document doc = Jsoup.connect("https://ww.mr-jatt.com/category.php?c=Hindi&p=" + Integer.toString(pageNum)).get();
