...
public class recyclerViewAdapterHome extends RecyclerView.Adapter<recyclerViewAdapterHome.MyViewHolder> {
    ...
    public recyclerViewAdapterHome(Context context, List<albumArt> data) {
        mContext = context;
        mData = data;
    }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView){
            super(itemView);
            artistSong = (TextView) itemView.findViewById(R.id.songArtist_textView_home);
            albumArt = (ImageView) itemView.findViewById(R.id.albumArt_imageView_home);
            mCardView = (CardView) itemView.findViewById(R.id.cardViewID_home);
        }
    }
}
