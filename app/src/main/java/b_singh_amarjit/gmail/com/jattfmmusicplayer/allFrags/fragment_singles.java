 ...
 */
public class fragment_singles extends Fragment {
    int pageNum = 1;
    ...
    private void getWebsiteInit() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Document doc = Jsoup.connect("https://ww.mr-jatt.com/category.php?c=Single%20Tracks&p=" + Integer.toString(pageNum)).get();
